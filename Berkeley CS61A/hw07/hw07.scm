...
(define (derive-sum expr var)
  'YOUR-CODE-HERE
  (begin
    (define first (car (cdr expr)))
    (define second (car (cdr (cdr expr))))
    (make-sum (derive first var) (derive second var)))
)
...
(define (derive-product expr var)
  ...
  (begin 
    (define first (car (cdr expr)))
    (define second (car (cdr (cdr expr))))
    (make-sum (make-product (derive first var) second) (make-product first (derive second var))))
)
